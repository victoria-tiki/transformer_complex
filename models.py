...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, inputs, mask=None, additional_mask=None):
        if mask is not None:
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, inputs, encoder_outputs, mask=None, additional_mask=None):
        ...
        attention_output_2, _ = self.attention_2(attention_output_1, encoder_outputs, encoder_outputs, key_padding_mask=None)
